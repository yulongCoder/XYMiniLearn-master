  ...
  data: {
    nodes: [{
      ...
      attrs: {
        // 标签上的属性 class style
        class: "my_div",
        style: "color:red; width:100px; height:100px;background-color:yellow;"
      },
